 ...
 * 2) FieldCollection(ArrayList<boundary>): like 1) but for the specified boundary list
...
public class FieldCollection1D
{
    ...
    /**returns field for the boundary, creates a new field if not yet in the collection*/
