...
public class MaterialInteraction {
	 ...
	 */
	public void setSurfaceImpactHandler(SurfaceImpactHandler surface_impact_handler) {
		this.surface_impact_handler = surface_impact_handler;
	}
	 ...
	 * @return
	 */
	public int getTargetMatIndex() {
		return target_mat_index;
	}
	 ...
	 * @return
	 */
	public int getSourceMatIndex() {
		return source_mat_index;
	}
	 ...
	 * @return
	 */
	public int getProductMatIndex() {
		return product_mat_index;
	}
	 ...
	 * @param c_rest
	 */
	public void setRestitutionCoefficient(double c_rest) {
		this.c_rest = c_rest;
	}
	 ...
	 * @param c_accom
	 */
	public void setAccomodationCoefficient(double c_accom) {
		this.c_accom = c_accom;
	}
	 ...
	 * @return
	 */
	public double getAccomodationCoefficient() {
		return c_accom;
	}
};
